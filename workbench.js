...
(function () {
  ...
  const copy={
    en:{skip:'Skip to workspace',refresh:'Refresh',devices:'Devices',selectDevice:'Select a device',back:'Back to devices',deviceHint:'Select a device to inspect every decoded field.',historyNote:'Dated samples only · 24 h mapped history and recent uplinks. Legacy time-only history is not plotted.',receiptNote:'Bridge receipt times · Lisbon',readOnly:'Receive only',sourceHealth:'Source health',healthNote:'Browser connectivity does not establish source health. Each source has its own receipt age.',meshGap:'Meshtastic RSSI, SNR and frame counts are not supplied by the current API. — means unavailable.',rawUplinks:'Raw LoRa uplinks',pause:'Pause display',resume:'Resume display',filter:'Device / topic filter',limit:'Display limit',rawNote:'Expand a packet to inspect its original JSON. Pause freezes this view; reception continues.',live:'Recent',stale:'Delayed',down:'Silent',unknown:'Unknown',never:'Time unavailable',emptyDevices:'No decoded devices received. Check System diagnostics.',emptyFields:'No decoded fields for this device.',emptyRaw:'No matching uplinks. Check the filter and source health.',choose:'Choose a device from the list.',fields:'fields',unitUnknown:'Unit not supplied',noTrend:'No dated samples available.',received:'Received',samples:'dated samples',browser:'Browser',bridge:'Bridge',mqtt:'MQTT',connected:'Connected',connecting:'Connecting',offline:'Disconnected',unavailable:'Unavailable',responding:'Responding',waiting:'Waiting',isolated:'Isolated',apiError:'API unavailable or invalid response. Retaining the last valid data. Retry with Refresh.',wsError:'Live connection disconnected. HTTP refresh continues every 30 s; reconnecting automatically.',demo:'Demonstration',demoNote:'Synthetic observations · no connection to the farm.',liveMode:'Live feed',lastResponse:'Last Bridge response',storageError:'Bridge reports a storage error.',noSources:'No sources received.',name:'Source',state:'State',lastSeen:'Last seen',frameCounter:'Frame counter',frames:'Frames',paused:'Display paused',shown:'shown',buffered:'buffered',missingRawTime:'Legacy time (date/timezone unavailable)',cadence:'Recent <90 min · delayed 90 min–3 h · silent ≥3 h',clock:'Lisbon',noSampleTime:'Field receipt time unavailable; device health is separate.',unknownField:'Decoded field',feed:'Admin stream'},
    zh:{skip:'跳转到工作台',refresh:'刷新',devices:'设备',selectDevice:'选择设备',back:'返回设备列表',deviceHint:'选择设备，查看全部已解码字段。',historyNote:'仅绘制有完整日期的采样 · 已映射字段近 24 小时历史及近期上行；不绘制仅有时分秒的旧记录。',receiptNote:'Bridge 接收时间 · 里斯本',readOnly:'仅接收',sourceHealth:'来源健康',healthNote:'浏览器连接不代表传感器健康。每个来源独立显示最近接收时间。',meshGap:'现有接口未提供 Meshtastic 的 RSSI、SNR 和帧数。— 表示数据不可用。',rawUplinks:'LoRa 原始上行',pause:'暂停显示',resume:'恢复显示',filter:'筛选设备 / 主题',limit:'显示条数',rawNote:'展开报文查看原始 JSON。暂停仅冻结当前视图，后台仍持续接收。',live:'新近',stale:'延迟',down:'静默',unknown:'未知',never:'时间不可用',emptyDevices:'尚无已解码设备，请检查系统诊断。',emptyFields:'此设备暂无已解码字段。',emptyRaw:'暂无匹配报文，请检查筛选条件及来源健康。',choose:'请从列表选择设备。',fields:'个字段',unitUnknown:'单位未提供',noTrend:'暂无包含完整日期的采样。',received:'接收于',samples:'个定时采样',browser:'浏览器',bridge:'Bridge',mqtt:'MQTT',connected:'已连接',connecting:'连接中',offline:'已断开',unavailable:'不可用',responding:'已响应',waiting:'等待响应',isolated:'已隔离',apiError:'接口不可用或响应格式错误，保留最近有效数据。请点击刷新重试。',wsError:'实时连接已断开。每 30 秒通过 HTTP 刷新，正在自动重连。',demo:'演示模式',demoNote:'观测值为模拟数据，未连接农场。',liveMode:'实时接收',lastResponse:'Bridge 最近响应',storageError:'Bridge 报告存储错误。',noSources:'尚未收到来源数据。',name:'来源',state:'状态',lastSeen:'最近接收',frameCounter:'帧计数器',frames:'帧数',paused:'显示已暂停',shown:'条显示',buffered:'条缓存',missingRawTime:'旧时间（日期及时区不可用）',cadence:'新近 <90 分钟 · 延迟 90 分钟–3 小时 · 静默 ≥3 小时',clock:'里斯本',noSampleTime:'字段接收时间不可用；设备健康单独显示。',unknownField:'解码字段',feed:'诊断数据流'}
  };
  const fieldNames={
